.. _isaacsim_sensors_rtx_IsaacComputeRTXLidarFlatScan_2:
...
.. meta::
    ...
    :keywords: lang-en omnigraph node isaacSensor rtx isaac-compute-r-t-x-lidar-flat-scan
...
.. csv-table::
    ...
    "Input time (*inputs:timeStamp*)", "``double``", "Input timestamp (s)", "0.0"
...
.. csv-table::
    ...
    "Timestamp (*outputs:timeStamp*)", "``double``", "Timestamp of first beam in scan", "0.0"
