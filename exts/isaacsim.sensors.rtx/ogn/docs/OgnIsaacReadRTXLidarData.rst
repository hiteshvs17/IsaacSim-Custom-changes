.. _isaacsim_sensors_rtx_IsaacReadRTXLidarData_1:

.. _isaacsim_sensors_rtx_IsaacReadRTXLidarData:
...
.. meta::
    ...
    :keywords: lang-en omnigraph node isaacSensor rtx isaac-read-r-t-x-lidar-data
...
.. csv-table::
    ...
    "Azimuths (*outputs:azimuths*)", "``float[]``", "azimuth in deg [-180, 180)", "[]"
...
.. csv-table::
    ...
    "Unique ID", "isaacsim.sensors.rtx.IsaacReadRTXLidarData"
    "Version", "1"
    "Extension", "isaacsim.sensors.rtx"
    "Icon", "ogn/icons/isaacsim.sensors.rtx.IsaacReadRTXLidarData.svg"
    "Has State?", "False"
